...
export default function SmartGlass({ theme }: { theme: any; isDark: boolean }) {
  return (
    <View style={styles.cardContainer}>
      ...
      <View style={[styles.consoleContainer, { backgroundColor: theme.backgroundElement, borderColor: theme.border }]}>
        <Text style={[styles.consoleLine, { color: theme.text }]}>[13:10:01] Loaded nodes for Smart Glass...</Text>
